...
const exportFullDatabaseToExcel = async (allData, cycle = 'CICLO 2025-2026') => {
    // Validar la estructura de entrada por adelantado
    if (!allData || !Array.isArray(allData.needs) || !Array.isArray(allData.schools)) {
        throw new Error('Formato de datos inválido: Se requieren las listas de "needs" y "schools" para generar el reporte.');
    }
    ...
    try {
        ...
        // Uso del parámetro 'cycle' en lugar de texto estático
        wsSchools.getRow(3).getCell(1).value = cycle;
